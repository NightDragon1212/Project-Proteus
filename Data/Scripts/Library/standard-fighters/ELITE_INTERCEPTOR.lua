...
return {
	Evaluate_Fighters = function(native,suffix,owner,alias,techLevel,regime,flags,is_main_empire)		
		...
		local proteustypes = {
			...
			ISECTOR = {"ION_SHIELDED_ARMORED_INTERCEPTOR_SQUADRON", false},
			...
			PRAKITH = {"ETA2_ACTIS_SQUADRON", false},
		--	PRENTIOCH = {"TRIFIGHTER_SQUADRON", false},--These still need to be ported from FoTR
			...
			CENTRALITY = {"TOSCAN_INTERCEPTOR_SQUADRON", false},
			ANAXES = {"TIE_X7_SQUADRON", false},
			SECRET = {"ELITE_SHIELDED_ARMORED_INTERCEPTOR_SQUADRON", false},
			SCREED = {"ETA2_ACTIS_SQUADRON", false},
