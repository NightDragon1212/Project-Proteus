...
return {
	Evaluate_Fighters = function(native,suffix,owner,alias,techLevel,regime,flags,is_main_empire)		
		...
		local proteustypes = {
			...
			ISECTOR = {"TIE_STARFIGHTER_SQUADRON", false}, --replace with tie light
			...
			RENDILI = {"UPGUNNED_TIE_INTERCEPTOR_SQUADRON", "TOSCAN_MISSILE_SQUADRON"},
			VEERS = {"SHIELDED_TIE_FIGHTER_SQUADRON", false},
			EMPIRE_REBORN = {"TIE_FIGHTER_SQUADRON", false},
			SECOND_IMPERIUM = {"TIE_FIGHTER_SQUADRON", false},
			LANOX = {"TIE_DROID_SQUADRON", false},
			STORM_COMMANDOS = {"TIE_FIGHTER_SQUADRON", false},
			THARKUS = {"TIE_FIGHTER_SQUADRON", false,
						{"TharkusMissile", "MISSILE_TIE_FIGHTER_SQUADRON", false}}, --research 1
