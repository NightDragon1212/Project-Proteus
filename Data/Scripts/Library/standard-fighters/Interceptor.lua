...
return {
	Evaluate_Fighters = function(native,suffix,owner,alias,techLevel,regime,flags,is_main_empire)		
		...
		local proteustypes = {
			...
			ISECTOR = {"TIE_INTERCEPTOR_ION_SQUADRON", false},
			...
			PRAJI = {"V38_SQUADRON", false},
			BALMORRA = {"NIMBUS_V_WING_SQUADRON", false,
					{"ProteusA9", "A9_SQUADRON", false}},
			RENDILI = {"UPGUNNED_SHIELDED_ARMORED_INTERCEPTOR_SQUADRON", "T_WING_SQUADRON"},
			...
			LANOX = {"A9_SQUADRON", false,
					{"LFU", "ION_SHIELDED_ARMORED_INTERCEPTOR_SQUADRON", false}}, --research 1
			STORM_COMMANDOS = {"ION_SHIELDED_ARMORED_INTERCEPTOR_SQUADRON", false},
			THARKUS = {"ARMORED_INTERCEPTOR_SQUADRON", false},
